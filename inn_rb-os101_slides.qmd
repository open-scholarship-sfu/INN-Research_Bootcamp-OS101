...
format:
  revealjs:
    ...
    footer: "INN Summer Research Bootcamp 2026 • bit.ly/inn-os101"
...
What is **one** thing I could make open in my research in the next 6 months?

:::{.left}
🔘 A preprint or journal article (e.g., via Summit)

🔘 A dataset or dataset metadata (e.g., field observations,
model outputs)

🔘 Code or analysis scripts (e.g., R, Python, GIS workflows)

🔘 A methods protocol (e.g., sampling, lab, or modelling work-
flow)
